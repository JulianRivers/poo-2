...
public class RegistroCarroController {
    ...
    void ingresar(ActionEvent event) throws Exception {
        Fachada.getInstance().ingresarVehiculo(txtPlaca.getText(), cbMarca.getSelectionModel().getSelectedIndex()+1, 
                ...
                cbCilindraje.getSelectionModel().getSelectedIndex()+1, Integer.parseInt((String) cbPuertas.getSelectionModel().getSelectedItem()), DataTransfer.getInstance().getVehiculo());
    }
